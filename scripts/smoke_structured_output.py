...
Usage:
    OPENAI_API_KEY=... python3 scripts/smoke_structured_output.py openai
    GOOGLE_API_KEY=... python3 scripts/smoke_structured_output.py google
    ANTHROPIC_API_KEY=... python3 scripts/smoke_structured_output.py anthropic
    DEEPSEEK_API_KEY=... python3 scripts/smoke_structured_output.py deepseek
